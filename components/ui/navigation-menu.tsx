...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute left-0 top-full flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top-center bg-popover/85 text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 dark:shadow-outline relative mt-3 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-xl border-DEFAULT shadow-lg backdrop-blur-2xl md:w-[var(--radix-navigation-menu-viewport-width)] dark:border-0 dark:bg-[rgba(50,50,50,0.55)]",
        className
      )}
      ref={ref}
      {...props}
