...
const HeroSection = () => {
  return (
    <>
      <div className="relative mt-16 flex h-[200px] select-none items-center justify-center text-center text-4xl font-extrabold leading-tight tracking-tighter sm:h-[300px] md:text-5xl lg:text-6xl xl:text-7xl">
        <Link
          href="/today"
      ...
      <div className="flex min-w-[350px] items-center justify-center gap-4 text-center text-xl drop-shadow-sm lg:min-w-full">
        <Link href="/today">
          <Button className="hover:shadow-inner-outline">Get Started</Button>
        </Link>
      </div>

      <div className="mt-16 flex min-w-[350px] flex-col items-center justify-center gap-4 text-center text-xl drop-shadow-sm lg:min-w-full">
        ...
        <div className="max-w-md text-base text-muted-foreground  sm:max-w-xl sm:text-lg md:max-w-2xl md:text-xl lg:max-w-4xl">
