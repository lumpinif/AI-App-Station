...
import { UpdateAppByTitle } from "@/server/queries/supabase/apps/editor"
                  ...
                  <FormItem>
                    <FormControl>
                      <Input
                        ...
                        {...field}
                        className="h-fit w-full text-nowrap border-0 bg-transparent p-0 text-lg font-bold outline-none ring-offset-background focus-visible:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 sm:text-3xl md:max-w-48 md:text-4xl"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
